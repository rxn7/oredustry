...
MainMenuScene::MainMenuScene() : od::Scene({255,255,255,255}) {
	...
	AddUiElement(std::shared_ptr<od::UI::Button>(new od::UI::Button("Exit", std::bind(&od::Game::ShutdownWithoutReason, od::Game::GetInstance()), {0, 300}, {150, 60}, {od::UI::Anchor::Center, od::UI::Anchor::Start})));
}
