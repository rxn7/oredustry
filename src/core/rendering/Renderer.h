...
namespace od::Renderer {
	...
	// Returns size of the rendered text
	glm::f32vec2 RenderText(const std::string &text, const od::Font &font, const glm::f32vec2 &position, const od::Color &color, float scale, od::TextAlignHorizontal alignH, od::TextAlignVertical alignV);
}
